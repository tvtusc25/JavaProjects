...
public class WordCounter3 
{
	...
	public WordCounter3( String data_structure )
	{
	...
	{
		WordCounter3 wordC = new WordCounter3("bst");
		//long average = 0;
		//ArrayList<Long> times = new ArrayList<Long>();
		//wordC.readWords("//Users/treytuscai/Desktop/School/CS231/TextFiles/reddit_comments_2008.txt");
		for(int year = 2008; year <= 2015; year++)
		{
			System.out.println("Year:" + year);
				wordC.clearMap();
				//System.out.println("Run: " + i);
				wordC.buildMap(wordC.readWords("/Users/treytuscai/Desktop/School/CS231/TextFiles/reddit_comments_" + year + ".txt"));
				wordC.writeWordCountFile("reddit" + year + "count");
		...
		//wordC.readWordCountFile("/Users/treytuscai/Desktop/counttest.txt");
